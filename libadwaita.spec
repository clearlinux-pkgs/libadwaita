...
Source0  : https://download.gnome.org/sources/libadwaita/1.1/libadwaita-1.1.2.tar.xz
...
%prep
%setup -q -n libadwaita-1.1.2
cd %{_builddir}/libadwaita-1.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654094373
...
cp %{_builddir}/libadwaita-1.1.2/COPYING %{buildroot}/usr/share/package-licenses/libadwaita/01a6b4bf79aca9b556822601186afab86e8c4fbf
