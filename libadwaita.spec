...
Source0  : https://download.gnome.org/sources/libadwaita/1.4/libadwaita-1.4.4.tar.xz
...
%prep
%setup -q -n libadwaita-1.4.4
cd %{_builddir}/libadwaita-1.4.4
pushd ..
cp -a libadwaita-1.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709415312
