...
Source0  : https://download.gnome.org/sources/libadwaita/1.6/libadwaita-1.6.0.tar.xz
...
%prep
%setup -q -n libadwaita-1.6.0
cd %{_builddir}/libadwaita-1.6.0
pushd ..
cp -a libadwaita-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726759518
