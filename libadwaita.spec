...
Source0  : https://download.gnome.org/sources/libadwaita/1.1/libadwaita-1.1.4.tar.xz
...
%prep
%setup -q -n libadwaita-1.1.4
cd %{_builddir}/libadwaita-1.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659968476
