...
Source0  : https://download.gnome.org/sources/libadwaita/1.5/libadwaita-1.5.2.tar.xz
...
%prep
%setup -q -n libadwaita-1.5.2
cd %{_builddir}/libadwaita-1.5.2
pushd ..
cp -a libadwaita-1.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719595073
