...
Source0  : https://download.gnome.org/sources/libadwaita/1.2/libadwaita-1.2.2.tar.xz
...
%prep
%setup -q -n libadwaita-1.2.2
cd %{_builddir}/libadwaita-1.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676248131
