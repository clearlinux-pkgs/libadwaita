...
Source0  : https://download.gnome.org/sources/libadwaita/1.1/libadwaita-1.1.5.tar.xz
...
%prep
%setup -q -n libadwaita-1.1.5
cd %{_builddir}/libadwaita-1.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662305837
