...
Source0  : https://download.gnome.org/sources/libadwaita/1.2/libadwaita-1.2.3.tar.xz
...
%prep
%setup -q -n libadwaita-1.2.3
cd %{_builddir}/libadwaita-1.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677974093
