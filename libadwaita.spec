...
Source0  : https://download.gnome.org/sources/libadwaita/1.1/libadwaita-1.1.0.tar.xz
...
%prep
%setup -q -n libadwaita-1.1.0
cd %{_builddir}/libadwaita-1.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647642026
...
cp %{_builddir}/libadwaita-1.1.0/COPYING %{buildroot}/usr/share/package-licenses/libadwaita/01a6b4bf79aca9b556822601186afab86e8c4fbf
