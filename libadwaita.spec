...
Source0  : https://gitlab.gnome.org/GNOME/libadwaita/-/archive/1.0.1/libadwaita-1.0.1.tar.gz
Source1  : https://gitlab.gnome.org/GNOME/libadwaita/-/archive/main/libadwaita-main.tar.gz
...
%prep
%setup -q -n libadwaita-1.0.1
cd %{_builddir}/libadwaita-1.0.1
cd ..
%setup -q -T -n libadwaita-main -b 1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641336570
